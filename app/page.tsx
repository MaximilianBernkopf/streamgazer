...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      {/* Multiline input box here, also dark mode, text in white */}
      <div className="mb-4 w-full max-w-md lg:mb-8 lg:max-w-2xl">  {/* Reduced mb-8 to mb-4 and lg:mb-16 to lg:mb-8 */}
        <textarea
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Just a simple ascii art representation of your topology.
          </p>
        </a>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-balance text-sm opacity-50">
            Cause it looks cool. Also, it is interactive.
          </p>
        </a>
      </div>
    </main>
